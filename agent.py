...
class Agent:
    def __init__(self, param_set):
        ...
        # FIX: Absolute path so it ALWAYS finds parameters.yaml
    ...
    def run(self, is_training=True, render=False):
        ...
        # FIX: Epsilon initialized here so it persists and testing doesn't crash
        ...
        for episode in itertools.count():
            ...
            while (not terminated and episode_reward < self.reward_threshold):
                # Exploration only happens if is_training=True
...
# To run training:  python -u "e:\Code\Flappy_Bird_RL\.vscode\Agent.py" flappybirdv0 --train
# To run testing: python -u "e:\Code\Flappy_Bird_RL\.vscode\Agent.py" flappybirdv0